...
```
implementation("com.itayc:iclogger:1.2") // the core files
implementation("com.itayc:iclogger-android-loggers:1.2") // extra logger implementations for android platform
```
